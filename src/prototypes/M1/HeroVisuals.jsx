...
export const BankingVisual = () => (
  <div style={{ position: 'relative', width: 500, height: 280 }}>
    ...
    <div style={{
      ...
      width: 263, height: 167, borderRadius: 9.4,
      overflow: 'hidden',
      ...
      <div style={{ position: 'absolute', inset: 0, backgroundImage: 'linear-gradient(48.89deg, rgb(127,98,197) 1.49%, rgb(232,222,248) 45.5%, rgb(132,105,208) 94.66%)', opacity: 0.65, borderRadius: 9.4 }} />
