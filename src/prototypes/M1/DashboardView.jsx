        ...
        {showBalancesView ? (
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-10 pt-6">
            <div className="w-full">
              {/* Hero Section */}
              {issuingHeadline ? (
                /* Deck-slide layout: toggle + two visuals */
                  ...
                  <div className="flex items-center gap-8 px-[72px] py-[52px]">
                    ...
                    <div className="flex flex-col gap-[22px] items-start w-[520px] shrink-0">
                      ...
                      <div className="flex gap-4">
                        <button onClick={() => setIsModalOpen(true)} className="px-4 py-2.5 bg-[#635bff] hover:bg-[#5851ea] text-white font-medium text-[14px] rounded-md transition-colors shadow-[0_1px_1px_rgba(47,14,99,0.32)]">
                          {hasStartedSetup ? 'Continue setup' : 'Get started'}
                        </button>
                        <button onClick={handleExploreSandbox} className="px-4 py-2.5 bg-white hover:bg-gray-50 text-[#353a44] font-medium text-[14px] rounded-md border border-[#d8dee4] transition-colors shadow-[0_1px_1px_rgba(33,37,44,0.16)]">
                          Explore in sandbox
                        </button>
                      </div>
                    </div>
