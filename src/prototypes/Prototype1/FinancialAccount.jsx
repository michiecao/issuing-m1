...
const FinancialAccount = ({
  ...
  // Types: 'transfer', 'send', 'createCard', 'convert', 'addFunds', 'transaction', 'card'
  ...
  const filteredTransactions = allTransactions.filter(t => {
    if (activeTab === 'money-in') return t.type === 'credit';
    if (activeTab === 'money-out') return t.type === 'debit';
      ...
      <div className="flex gap-3 overflow-x-auto pb-2">
        {buckets.map((bucket) => (
          <Bucket
            ...
            onClick={() => { setSelectedBucket(bucket); setSelectedCurrencyIndex(0); }}
